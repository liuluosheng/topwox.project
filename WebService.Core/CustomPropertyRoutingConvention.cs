    ...
    public class MatchRoutingConvention : IODataRoutingConvention
    {
        ...
        public IEnumerable<ControllerActionDescriptor> SelectAction(RouteContext routeContext)
        {
            ...
            if (odataPath.Segments.FirstOrDefault() is EntitySetSegment)
            {
                ...
                var type = Assembly.GetEntryAssembly().CreateInstance(collectionType != null ? collectionType.ElementType.Definition.ToString() : odataPath.EdmType?.ToString())?.GetType();
             //   var type = typeof(EntityBase).Assembly.CreateInstance(collectionType != null ? collectionType.ElementType.Definition.ToString() : odataPath.EdmType?.ToString()).GetType();
